<template>
  <main-layout>
    <div class="wrapper my-20 grid gap-10 justify-center">
      <div>
        <h1 class="text-2xl text-center mb-8">Власноруч повторені списки</h1>
        <div class="flex gap-8">
          <paginated-list list-title="Список працівників" :items="usersList" />
          <paginated-exp-list
